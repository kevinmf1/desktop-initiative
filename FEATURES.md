...
|------|:--------:|---------------|
| Harness setup | 1/1 | — |
| Desktop app (Tauri) | 3/20 | feat-007 … feat-023 (all 🟡) |
...
| feat-009 | Test Case CRUD — derived summary status (`Has Fail → Blocked → In Progress → All Passed → Not Run`, computed on read), Active/Archived flag, platform iOS/Android/Both — FR-003, FR-003a, FR-003b, FR-003c | 🟡 | — | feat-008 | — |
